...
const accessKey="8o4cB3o0HgxIkayHnq-PcIT3VPSESKCmY2czHaB7TM0"
let page=1;
let keyword=""
...
async function getResponse() {
    ...
    keyword=input.value
    let url=`https://api.unsplash.com/search/collections?page=${page}&query=${keyword}&client_id=8o4cB3o0HgxIkayHnq-PcIT3VPSESKCmY2czHaB7TM0`
